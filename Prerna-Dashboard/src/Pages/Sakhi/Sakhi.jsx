...
const Sakhi = () => {
  ...
  const quickActions = [
    ...
    { icon: <ChefHat className="w-4 h-4" />, text: "What should I cook today?", category: "daily" },
    { icon: <Briefcase className="w-4 h-4" />, text: "Give me a job tip", category: "career" },
    { icon: <GraduationCap className="w-4 h-4" />, text: "Help with my assignment", category: "study" },
    ...
    { icon: <Heart className="w-4 h-4" />, text: "Daily motivation", category: "motivation" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-red-500 to-rose-500 rounded-3xl p-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-white/90 mb-4">24/7 helplines for safety and support</p>
            ...
            <button className="bg-white text-red-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all flex items-center space-x-2">
